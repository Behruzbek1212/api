...
@php
    ...
    if (! function_exists('calculateYearsAndMonthsAdmin')) {
        function calculateYearsAndMonthsAdmin($months):string {
    ...
    $all_experience = calculateYearsAndMonthsAdmin($experience);
                                ...
                                <tr class="w-full">
                                    ...
                                    <td>
                                        ...
                                        <p style="font-size: 10px" class="font-semibold">
                                            {{
                                              calculateYearsAndMonthsAdmin(calculateEmployment($employment))
                                            }}
                                        </p>
                                    </td>
                                </tr>
