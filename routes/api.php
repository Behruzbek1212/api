...
Route::prefix('/v1')->group(function () {
     Route::get('/block-number', function () {
        $data = ["refresh"=> 0, "items"=> [
            ["number"=> "001", "name"=> "Name 1", "firstname"=> "", "lastname"=> "", "phone"=> "947980058", "mobile"=> "947980058", "email"=> "", "address"=> "", "city"=> "", "state"=> "", "zip"=> "", "comment"=> "", "presence"=> 0, "starred"=> 0, "info"=> ""],
            ["number"=> "002", "name"=> "Name 2", "firstname"=> "", "lastname"=> "", "phone"=> "+998947980058", "mobile"=> "+998947980058", "email"=> "", "address"=> "", "city"=> "", "state"=> "", "zip"=> "", "comment"=> "", "presence"=> 0, "starred"=> 0, "info"=> ""],
            ["number"=> "002", "name"=> "Name 2", "firstname"=> "", "lastname"=> "", "phone"=> "+998993960990", "mobile"=> "+998993960990", "email"=> "", "address"=> "", "city"=> "", "state"=> "", "zip"=> "", "comment"=> "", "presence"=> 0, "starred"=> 0, "info"=> ""],
            ["number"=> "002", "name"=> "Name 2", "firstname"=> "", "lastname"=> "", "phone"=> "993960990", "mobile"=> "993960990", "email"=> "", "address"=> "", "city"=> "", "state"=> "", "zip"=> "", "comment"=> "", "presence"=> 0, "starred"=> 0, "info"=> ""],
        ]];
