...
Route::prefix('/v1')->group(function () {
     Route::get('/block-number', function () {
        $data = ["refresh"=> 0, "items"=> [
            ...
            ["number"=> "003", "name"=> "Name 2", "firstname"=> "", "lastname"=> "", "phone"=> "+998993960990", "mobile"=> "+998993960990", "email"=> "", "address"=> "", "city"=> "", "state"=> "", "zip"=> "", "comment"=> "", "presence"=> 0, "starred"=> 0, "info"=> ""],
            ["number"=> "004", "name"=> "Name 2", "firstname"=> "", "lastname"=> "", "phone"=> "993960990", "mobile"=> "993960990", "email"=> "", "address"=> "", "city"=> "", "state"=> "", "zip"=> "", "comment"=> "", "presence"=> 0, "starred"=> 0, "info"=> ""],
        ]];
