...
class UpdateResumeRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'data.links.other' => 'nullable|string',
            'data.links.gitHub' => 'nullable|string',
            'data.links.behance' => 'nullable|string',
            'data.links.linkedin' => 'nullable|string',
            'data.links.telegram' => 'nullable|string',
            'data.links.whatsapp' => 'nullable|string',
            'data.links.instagram' => 'nullable|string',
