...
class JobResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            "work_hours"=> $this->work_hours ?? null ?? null,
            'for_communication_phone' => $this->for_communication_phone ?? null ?? null,
            'for_communication_link' => $this->for_communication_link ?? null ?? null, 
